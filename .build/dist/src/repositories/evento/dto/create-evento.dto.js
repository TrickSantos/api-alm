...
__decorate([
  (0, class_validator_1.IsNotEmpty)({ message: "A pontua\xE7\xE3o do evento precisa ser informada!" }),
  (0, class_validator_1.IsInt)(),
  (0, class_validator_1.Min)(0, { message: "A pontua\xE7\xE3o precisa ser maior que 0 (zero)" }),
